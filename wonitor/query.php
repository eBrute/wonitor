    ...
    function queryDB(&$db, $dbStructure, $table) {
        ...
        foreach ($_GET as $key => $value) {
            ...
            if (($constraintField == 'map' || $constraintField == 'mapName') && strpos($value, '@official') !== false) {
                $officialMaps = 'ns2_biodome,ns2_caged,ns2_derelict,ns2_descent,ns2_docking,ns2_eclipse,ns2_kodiak,ns2_mineshaft,ns2_refinery,ns2_summit,ns2_tram,ns2_veil,ns2_unearthed';
